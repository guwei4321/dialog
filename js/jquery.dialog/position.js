(function(root, factory) {
    ...
    function position(opts) {
        ...
        var $elBase = $(opts.baseElement),
            ...
            parentElementOffset = posConverter(opts.parentAlign, $elParent.outerWidth(), $elParent.outerHeight()),
            baseElementOffset = posConverter(opts.baseAlign, $elBase.outerWidth(), $elBase.outerHeight())
